...
SOURCES = start_semestralka.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c snake.c player.c food.c board.c draw_module.c
SOURCES += font_prop14x16.c font_rom8x16.c periferial_module.c draw_tools.c window_module.c settings.c game_selector.c
SOURCES += path_finding.c
TARGET_EXE = snake_semestralwork
